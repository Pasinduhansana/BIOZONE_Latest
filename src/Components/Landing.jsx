...
const Landing = () => {
  ...
  return (
    <div className="2xl:px-52 xl:px-24 px-10 relative max-h-[250vh] h-auto lg:h-screen w-screen flex  flex-col lg:flex-row  items-center justify-start lg:justify-between gap-10 lg:gap-40 overflow-hidden">
      ...
      >
        <motion.div
          className="text-[13px] xl:text-[15px] 2xl:text-[16px] flex items-center justify-center -mb-4 text-primary1 border-[1.5px] lg:border-2 bg-white border-primary1 rounded-[4px]  lg:rounded-[8px] h-[28px] w-auto lg:h-[36px] lg:w-[265px]  transition-all duration-200 ease-linear px-2"
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <SecondaryButton TextContent={currentContent.viewTimetables} />
        </motion.div>
      </motion.div>
      <motion.div
