	...
	return (
		<div className="2xl:px-52 xl:px-24 px-10 relative max-h-[250vh] h-auto lg:h-screen w-screen flex  flex-col lg:flex-row  items-center justify-start lg:justify-between gap-10 lg:gap-40 overflow-hidden">
			...
			<div className="relative h-[450px] lg:h-auto flex flex-col gap-5 items-center justify-center mt-16 lg:mt-[20vh] w-[300px] lg:w-[450px]  ">
				...
				{/* Glass Effect Cards */}
				<div className="absolute z-40 flex flex-col lg:-top-10 lg:-left-15 top-5 -left-2 justify-center  text-primary1 items-center rounded-[8px]  w-[120px] h-[60px] lg:w-[140px] lg:h-[90px] bg-[#FFFFFF99] backdrop-blur-[30px] shadow-[0px_4px_34.6px_0px_#0000001A] animate-orbit">
					<h1 className="text-[28px] xl:text-[36px] 2xl:text-[40px] ">+10</h1>
					<h1 className="text-[14px] xl:text-[16px] 2xl:text-[18px] font-thin mb-2">
						Experience
					</h1>
				</div>
				<div className="absolute z-40 flex flex-row items-center justify-center bottom-4 lg:bottom-24 -left-10 lg:-left-28 text-primary1  rounded-[8px] w-[240px] h-[70px] lg:w-[312px] lg:h-[91px] bg-[#FFFFFF99] backdrop-blur-[30px] shadow-[0px_4px_34.6px_0px_#0000001A] animate-orbit2">
				...
				<div className="absolute z-40 flex flex-col justify-center items-center text-primary1 -right-10 top-58 rounded-[8px] w-[160px] h-[50px] lg:w-[190px] lg:h-[68px] bg-[#FFFFFF99] backdrop-blur-[30px] shadow-[0px_4px_34.6px_0px_#0000001A] animate-orbit3">
