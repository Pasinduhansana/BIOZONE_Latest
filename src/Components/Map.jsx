...
import classimage from "../Assest/Web_Images/4.jpg";
	...
	return (
		<div className="container mx-auto relative min-h-[200vh] lg:min-h-screen mt-10 lg:mt-0">
			...
			<div className="flex justify-center">
				<div className="grid lg:grid-cols-2 grid-cols-1 gap-8 justify-center">
					{data.map((institute, index) => (
						...
						>
							<div className="lg:h-3/5  h-2/3 l"></div>
							<div className=" p-2 pl-5 h-1/3 lg:h-2/5 mt-2 bg-[#FFFFFF99] backdrop-blur-[10px] flex flex-col gap-2 border-none ">
			...
			{isModalOpen && (
				<div className="fixed inset-0  flex items-center justify-center backdrop-blur-[10px] bg-black bg-opacity-10 z-50">
					<div className="bg-white lg:w-4/5 lg:h-5/6 w-full h-full  relative rounded-lg">
						...
						<div className="absolute  bg-[#FFFFFF99] backdrop-blur-[5px] lg:p-4 bottom-0 rounded-[16px] w-screen lg:w-5/12 -mb-5 lg:mb-0 2xl:w-4/12 h-[400px] lg:h-auto lg:top-1/2 lg:right-5 transform  pb-5 lg:pb-0 translate-y-* lg:-translate-y-1/2 flex items-center justify-center shadow-lg">
